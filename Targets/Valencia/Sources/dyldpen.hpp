...
public:
    ...
    struct LinkContext {
            ...
            void            (*notifySingle)(int, const ImageLoader* image, InitializerTimingList*);
            void            (*notifyBatch)(int state, bool preflightOnly);
        ...
        virtual void                        getUnwindInfo(void* info) = 0;
        ...
        virtual    bool                        getUUID(int) const = 0;
    ...
    //
        ...
        int                    getState() { return (int)fState; }

        int                                getInode() const { return fInode; }
    ...
    protected:
        ...
        void                        setFileInfo(dev_t device, int inode, time_t modDate);
